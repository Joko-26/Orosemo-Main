...
function DesktopMenu() {
  ...
  return (
    <div className="flex gap-4">
      <Link
        to="/"
        className="text-l md:text-xl lg:text-2xl xl:text-3xl font-medium hover:underline"
      >
        {t.home}
      </Link>
      <Link
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left">
        ...
        <nav className="mt-4 flex flex-col gap-2 m-4">
          <Link
            to="/"
            className="headline font-medium hover:underline"
            onClick={handleClose}
          >
            {t.home}
          </Link>
    ...
    <header className="border-b md:pl-4 sticky" id="header">
      <div className="flex w-full h-16 items-center justify-between border-r-border md:pr-4">
        <div className="flex items-center space-x-1 scale-75 sm:scale-90 md:scale-100">
          ...
          <span className="font-bold text-l md:text-xl lg:text-2xl xl:text-3xl">
            Orosemo
          </span>
        </div>
